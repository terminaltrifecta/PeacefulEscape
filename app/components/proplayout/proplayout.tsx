...
export default function Proplayout({ box1, box2, box3, box4, box5 }: any) {
  return (
    <div className="grid p-8 gap-8 md:grid-cols-2">
      <div className="h-36 md:h-80 w-full join join-vertical md:row-span-2">
      ...
      <div className="h-36 md:h-80 md:row-span-2 card bg-primary">{box3}</div>
      <div className="h-36 card bg-primary">{box4}</div>
      <div className="h-36 card bg-purple-500 md:col-span-2">{box5}</div>
    </div>
  );
}
