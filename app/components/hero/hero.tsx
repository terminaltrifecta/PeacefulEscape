...
export default function Hero() {
  return (
    <div className="hero h-screen text-accent-content">
      <div className="min-w-fit w-3/4 md:flex md:items-center md:justify-center card -translate-y-10 z-10">
        <div className="grid gap-4 text-center md:text-left ">
          <div className="text-4xl md:text-7xl font-extrabold text-neutral stroke">
            Peaceful Escapes
          </div>
          <div className="text-4xl md:text-7xl font-extrabold text-neutral stroke">
            Accommodation
